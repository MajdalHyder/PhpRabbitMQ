...
class Database
{
    ...
    {
        $this->DatabaseConnection = pg_connect(
            "host=" . $_ENV['DB_HOST'] . 
            " port=" . $_ENV['DB_PORT'] . 
            " dbname=" . $_ENV['DB_NAME'] .
        ...
        if(!$this->DatabaseConnection) exit();
    }
    ...
    {
        $result = pg_query($this->DatabaseConnection, $sql);
    ...
    {
        $result = pg_query($this->DatabaseConnection, $query)   ;
        return $result;
    }
}
